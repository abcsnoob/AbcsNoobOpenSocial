...
There is **no backend server** to take down.
...
Developers have **no special powers**.
Taking down one node changes nothing.
...
<a href="https://www.star-history.com/#abcsnoob/AbcsNoobOpenSocial&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=abcsnoob/AbcsNoobOpenSocial&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=abcsnoob/AbcsNoobOpenSocial&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=abcsnoob/AbcsNoobOpenSocial&type=date&legend=top-left" />
 </picture>
</a>
